...
<html lang="en">
	<head>
		...
		<?php 
			...
			if($str = legacy_esc($meta_tags, true)){
		...
		<?php
			//echo legacy_esc($scripts['header'], true);
		?>
		<!-- Global site tag (gtag.js) - Google Analytics -->
		<script async src="https://www.googletagmanager.com/gtag/js?id=<?php echo legacy_esc($analytics, true); ?>"></script>
		<script>
			window.dataLayer = window.dataLayer || [];
			function gtag(){dataLayer.push(arguments);}
			gtag('js', new Date());

			gtag('config', '<?php echo legacy_esc($analytics, true); ?>');
		</script>
