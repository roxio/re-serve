		...
		<nav class="navbar">
			<div class="container">
				...
				<div class="ml-auto d-flex align-items-center">
					<div class="mainMenu">
						<ul id="myDIV">
							...
							<?php foreach($pages as $page) { if($page['status'] && ($page['position'] == 1 || $page['position'] == 3)) { ?>
								<li class="bdtn"><a href="<?php anchor_to('page/' . $page['permalink']) ?>"><?php echo legacy_esc($page['title'], true) ?></a></li>
							<?php } } ?>
					...
					<a href="<?php echo base_url($session->get('admin_id') ? GENERAL_CONTROLLER . '/dashboard' : AUTH_CONTROLLER . '/login'); ?>" class="adminIconLink" title="Panel administratora" aria-label="Panel administratora">
