	...
	<div class="mainSection endUser">
		<div class="container">
            <div class="profileSetting selectionBoxMain clearfix">
                <h1 class="profileTitle"><a href="#"><i class=""></i></a><?php echo legacy_esc($title, true); ?></h1>
                <div class="pt-3">
                    <div class="afterContinueMain">
                        <div class="afterContinue">
                            ...
                            <ul class="serviceDetail">
                                <li><h5><span id="serviceTitle"><?php echo legacy_esc($service['title'], true); ?></span></h5></li>
                                <li><span class="labels">Date:</span> <?php echo legacy_esc($booking['date'], true); ?></li>
                                <li><span class="labels">Time:</span> <?php echo legacy_esc($booking['timing'], true); ?></li>
                                <li><span class="labels">No of guest:</span> <?php echo legacy_esc($booking['adults'], true); ?> Adults - <?php echo legacy_esc($booking['childrens'], true); ?> Children</li>
                                <li><span class="labels">Service Price:</span> $<?php echo legacy_esc($service['price'], true); ?></li>
                                <li><span class="labels">Total Price:</span> $<?php echo (legacy_esc($booking['adults'], true) + legacy_esc($booking['childrens'], true))*legacy_esc($service['price'], true); ?></li>
                            </ul>
                        </div>
                    </div>
                    <hr>
                    <form id="serviceUserForm" method="post" action="<?php echo base_url('userbooking/paynow/'.legacy_esc($booking['id'], true));?>">
                    <div class="afterContinueMain">
