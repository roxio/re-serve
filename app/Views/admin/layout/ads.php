						...
						<div class="row">
							<div class="col-md-6 ">
								<div class="form-group">
									...
									<input type="text" name="site-top-ad-code" class="mb-4 form-control form-control-lg resize-none" placeholder="Enter your Top image Ad URL right here." value="<?php echo legacy_esc($page_data['ads']['top']['code'], true) ?>">
									<?php if($page_data['ads']['top']['status']) { ?>
										<small class="mt-2">Currently Applied:<br> <code class="p-2 rounded bg-secondary text-white d-block"><?php echo legacy_esc($page_data['ads']['top']['code'], true) ?></code></small>
									<?php } ?>
								</div>
							</div>
							<div class="col-md-6 ">
								<div class="form-group">
									...
									<small>Only add link for add Ex: http://</small>
										...
										<input type="text" name="site-bottom-ad-code" class="mb-4 form-control form-control-lg resize-none"  placeholder="Enter your Bottom image Ad URL right here." value="<?php echo legacy_esc($page_data['ads']['bottom']['code'], true) ?>">
										<?php if($page_data['ads']['bottom']['status']) { ?>
												<small class="mt-2">Currently Applied:<br> <code class="p-2 rounded bg-secondary text-white d-block"><?php echo legacy_esc($page_data['ads']['bottom']['code'], true) ?></code></small>
										<?php } ?>
								</div>
							</div>
					</div>
