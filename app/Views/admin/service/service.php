                            ...
                            <div class="table-responsive">
                                <table class="table table-striped mt-3">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            <td><?php echo legacy_esc($serv['id'], true) ?></td>
                                            <td><?php echo legacy_esc($serv['title'], true) ?></td>
											<td>
											<?php 
												$agents = '';
												...
												$agents = trim($agents, ', ');
												echo legacy_esc($agents, true);
											?>
											</td>
                                            <td><?php echo legacy_esc($serv['description'], true) ?></td>
                                            <td><?php echo legacy_esc($serv['price'], true) ?></td>
                                            <td><?php echo legacy_esc($serv['servDuration'], true) ?></td>
                                            <td>
                                                ...
                                                <button type="button" class="btn btn-link btn-danger deleteService" data-toggle="tooltip" data-placement="top" title="Delete" value="<?php echo legacy_esc($serv['id'], true) ?>"><i class="fa fa-times"></i></button>
                                            </td>
                                        </tr>
                                        <?php } }?>
                                    </tbody>
