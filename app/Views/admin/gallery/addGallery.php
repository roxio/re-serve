                    ...
                    <div class="card">
                            <div class="card-body">
                                <div class="form-group">
                                    ...
                                    <input class="form-control" type="text" id="image-title" name="image-title" placeholder="Choose Image Title" value="<?php echo legacy_esc(set_value('image-title'), true)?>">
                                </div>
                                <div class="form-group">
                                    ...
                                    <textarea id="service-content" name="image-content" class="form-control" placeholder="Choose Image Short Description"><?php echo legacy_esc(set_value('image-content'), true)?></textarea>
                                </div>
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <select name="categoryId" id="" class="form-control custom-select">
                                                ...
                                                <?php foreach($categories as $gCat){ ?>
                                                    <option value="<?php echo legacy_esc($gCat['id'], true)?>"><?php echo legacy_esc($gCat['cName'], true)?></option>
                                                <?php } ?>
                                            </select>
                                        </div>
                                    </div>
